                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-user"></i><a href="<?php echo base_url('admin/user') ?>">View User</a></li>
                            <li><i class="fa fa-user-plus"></i><a href="<?php echo base_url('admin/user/tambah') ?>">Add User</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
